...
title('GloVe Embeddings (11 Topics)')
...
title("3-D GloVe Embeddings (11 Topics)")
...
title("Cosine Similarities of Word Vectors (11 Topics) via GloVe")
...
title("Feature Word Cosine Similarities of Word Vectors (11 Topics) via GloVe")
...
ylabel('Occurences');
title('Feature Word Occurences per Topic (11 Topics)');
...
ylabel("Topics")
title("Topic Relevancy of each Conversation (11 Topics) - GloVe")
