...
title('GloVe Embeddings (13 Topics)')
...
title("3-D GloVe Embeddings (13 Topics)")
...
title("Cosine Similarities of Word Vectors (13 Topics) via GloVe")
...
xlim([0 1])
title("Conversation Topic Mixtures (11 Topics)")
...
title("Feature Word Cosine Similarities of Word Vectors (13 Topics) via GloVe")
...
ylabel('Occurences');
title('Feature Word Occurences per Topic (13 Topics)');
...
ylabel("Topics")
title("Topic Relevancy of each Conversation (13 Topics) - GloVe")
