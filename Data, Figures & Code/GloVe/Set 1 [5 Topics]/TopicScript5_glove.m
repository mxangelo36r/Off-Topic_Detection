...
title('GloVe Embeddings (5 Topics)')
...
title("3-D GloVe Embeddings (5 Topics)")
...
title("Cosine Similarities of Word Vectors (5 Topics) via GloVe")
...
title("Feature Word Cosine Similarities of Word Vectors (5 Topics) via GloVe")
...
ylabel('Occurences');
title('Feature Word Occurences per Topic (5 Topics)');
...
ylabel("Topics")
title("Topic Relevancy of each Conversation (5 Topics) - GloVe")
