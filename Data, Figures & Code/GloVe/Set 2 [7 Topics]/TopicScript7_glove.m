...
title('GloVe Embeddings (7 Topics)')
...
title("3-D GloVe Embeddings (7 Topics)")
...
title("Cosine Similarities of Word Vectors (7 Topics) via GloVe")
...
title("Feature Word Cosine Similarities of Word Vectors (7 Topics) via GloVe")
...
ylabel('Occurences');
title('Feature Word Occurences per Topic (7 Topics)');
...
ylabel("Topics")
title("Topic Relevancy of each Conversation (7 Topics) - GloVe")
