...
data = importdata("data_train[11].txt");
...
title('Word2vec Embeddings (11 Topics)')
...
title("3-D Word2vec Embeddings (11 Topics)")
...
title("Cosine Similarities of Word Vectors (11 Topics) via word2vec")
...
title("Corpus Topic Probabilities (11 Topics)")
xlabel("Topics")
ylabel("Probability")
...
ylabel("Probability")
title("Conversation Topic Probabilities (11 Topics)")
...
title("Feature Word Cosine Similarities of Word Vectors (11 Topics) via word2vec")
...
legend('Topic 1', 'Topic 2', 'Topic 3', 'Topic 4', 'Topic 5', 'Topic 6', 'Topic 7', 'Topic 8', 'Topic 9', 'Topic 10', 'Topic 11');
...
ylabel("Topics")
title("Topic Relevancy of each Conversation (11 Topics) - word2vec")
