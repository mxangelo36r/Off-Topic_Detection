...
data = importdata("data_train[7].txt");
...
title('Word2vec Embeddings (7 Topics)')
...
title("3-D Word2vec Embeddings (7 Topics)")
...
title("Cosine Similarities of Word Vectors (7 Topics) via word2vec")
...
title("Corpus Topic Probabilities (7 Topics)")
xlabel("Topics")
ylabel("Probability")
...
xlim([0 1])
title("Conversation Topic Mixtures (7 Topics)")
...
ylabel("Probability")
title("Conversation Topic Probabilities (7 Topics)")
...
title("Feature Word Cosine Similarities of Word Vectors (7 Topics) via word2vec")
...
ylabel('Occurences');
title('Feature Word Occurences (7 Topics)');
set(gca, 'XTickLabel', rowVector);
legend('Topic 1', 'Topic 2', 'Topic 3', 'Topic 4', 'Topic 5', 'Topic 6', 'Topic 7');
...
ylabel("Topics")
title("Topic Relevancy of each Conversation (7 Topics) - word2vec")
