...
data = importdata("data_train[5].txt");
...
title('Word2vec Embeddings (5 Topics)')
...
title("3-D Word2vec Embeddings (5 Topics)")
...
title("Cosine Similarities of Word Vectors (5 Topics) via word2vec")
...
title("Corpus Topic Probabilities (5 Topics)")
xlabel("Topics")
ylabel("Probability")
...
xlim([0 1])
title("Conversation Topic Mixtures (5 Topics)")
...
ylabel("Probability")
title("Conversation Topic Probabilities (5 Topics)")
...
title("Feature Word Cosine Similarities of Word Vectors (5 Topics) via word2vec")
...
ylabel('Occurences');
title('Feature Word Occurences (5 Topics)');
...
ylabel("Topics")
title("Topic Relevancy of each Conversation (5 Topics) - word2vec")
