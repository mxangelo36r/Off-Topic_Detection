...
title('Word2vec Embeddings (9 Topics)')
...
title("3-D Word2vec Embeddings (9 Topics)")
...
title("Cosine Similarities of Word Vectors (9 Topics) via word2vec")
...
title("Feature Word Cosine Similarities of Word Vectors (9 Topics) via word2vec")
...
ylabel("Topics")
title("Topic Relevancy of each Conversation (9 Topics) - word2vec")
