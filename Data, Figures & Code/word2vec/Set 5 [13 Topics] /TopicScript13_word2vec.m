...
data = importdata("data_train[13].txt");
...
title('Word2vec Embeddings (13 Topics)')
...
title("3-D Word2vec Embeddings (13 Topics)")
...
title("Cosine Similarities of Word Vectors (13 Topics) via word2vec")
...
title("Corpus Topic Probabilities (13 Topics)")
xlabel("Topics")
ylabel("Probability")
...
xlim([0 1])
title("Conversation Topic Mixtures (13 Topics)")
...
ylabel("Probability")
title("Conversation Topic Probabilities (13 Topics)")
...
title("Feature Word Cosine Similarities of Word Vectors (13 Topics) via word2vec")
...
ylabel('Occurences');
title('Feature Word Occurences (9 Topics)');
set(gca, 'XTickLabel', rowVector);
legend('Topic 1', 'Topic 2', 'Topic 3', 'Topic 4', 'Topic 5', 'Topic 6', 'Topic 7', 'Topic 8', 'Topic 9', 'Topic 10', 'Topic 11', 'Topic 12', 'Topic 13');
...
ylabel("Topics")
title("Topic Relevancy of each Conversation (13 Topics) - word2vec")
